...
import org.example.cayenne.persistent.Galary;

/**
 * Class _Paiting was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _Paiting extends BaseDataObject {
    ...
    public static final EntityProperty<Galary> GALARY = PropertyFactory.createEntity("galary", Galary.class);

    protected String name;

    protected Object artist;
    protected Object galary;
    ...
    public void setGalary(Galary galary) {
        setToOneTarget("galary", galary, true);
    }

    public Galary getGalary() {
        return (Galary)readProperty("galary");
    }
