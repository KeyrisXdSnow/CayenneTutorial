...
import org.example.cayenne.persistent.Gallary;
...
public abstract class _Painting extends BaseDataObject {
    ...
    public static final EntityProperty<Gallary> GALLARY = PropertyFactory.createEntity("gallary", Gallary.class);

    protected String name;

    protected Object artist;
    protected Object gallary;
    ...
    public void setGallary(Gallary gallary) {
        setToOneTarget("gallary", gallary, true);
    }

    public Gallary getGallary() {
        return (Gallary)readProperty("gallary");
    }
